...
OV_CONFIG_RELEASE_OPTION(ov, cache_ov_major_version, 0, "ov major version of cache")
OV_CONFIG_RELEASE_OPTION(ov, cache_mode, ov::CacheMode::OPTIMIZE_SIZE, "Cache mode defines the trade-off between the model compilation time and the disk space required for the cache")
...
OV_CONFIG_RELEASE_INTERNAL_OPTION(ov::intel_gpu, max_kernels_per_batch, 1, "Controls how many kernels we combine into batch for more efficient ocl compilation")
