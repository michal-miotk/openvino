...
struct GRUSeqImplementationManager: public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("ocl::gru_seq")
    GRUSeqImplementationManager(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, vf) {}
