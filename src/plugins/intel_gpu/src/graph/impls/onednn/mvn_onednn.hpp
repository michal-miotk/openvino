...
struct MVNImplementationManager : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("onednn::mvn")
    MVNImplementationManager(shape_types shape_type) : ImplementationManager(impl_types::onednn, shape_type) {}
    ...
    bool validate_impl(const program_node& node) const override {
        ...
        const auto& lstm_seq_node = node.as<mvn>();
