...
static void CreateLSTMCellOp(ProgramBuilder& p, const std::shared_ptr<ov::op::v4::LSTMCell>& op) {
    ...
    if (p.use_new_shape_infer()) {
        ...
        p.add_primitive(*op, cldnn::lstm_elt(lstm_elt_id, cldnn::input_info(lstm_fc_id), {}, {}, {}, {}, {}, {}, {}, {}, \
            clip, false, activations, activation_params, cldnn::lstm_weights_order::fizo, 0, inputs[2].pid));
        ...
        p.add_primitive(*op, cldnn::lstm_elt(lstm_elt_id, cldnn::input_info(gemmReorderID), {}, {}, {}, {}, {}, {}, {}, {}, \
            clip, false, activations, activation_params, cldnn::lstm_weights_order::fizo, 0, cellInStr));
