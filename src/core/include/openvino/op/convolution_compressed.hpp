...
class OPENVINO_API ConvolutionCompressed : public util::ConvolutionFwdPropBase {
public:
    OPENVINO_OP("ConvolutionCompressed", "opset1", op::util::ConvolutionFwdPropBase);
    ...
    ///
    ConvolutionCompressed(const Output<Node>& data_batch,
