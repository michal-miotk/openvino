...
//////////////////////
bool op::v6::LSTMSequence::visit_attributes(AttributeVisitor& visitor) {
    OV_OP_SCOPE(v6_LSTMSequence_visit_attributes);
    visitor.on_attribute("direction", m_direction);
    return op::util::RNNCellBase::visit_attributes(visitor);
}

std::shared_ptr<Node> op::v6::LSTMSequence::clone_with_new_inputs(const OutputVector& new_args) const {
...
void op::v6::LSTMSequence::validate_and_infer_types() {
    OV_OP_SCOPE(v6_LSTMSequence_validate_and_infer_types);
